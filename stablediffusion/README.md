...
- at each timestep of adding noise to image (in UNET), we keep reducing dimension  but at same time we keep increasing features i.e each pixel will be represented by more increasing number of channels, capturing more data and finer details 
