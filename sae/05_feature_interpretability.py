...
# - Distinguish polysemantic features from clean monosemantic features.
# - Validate interpretations with counterexamples instead of relying on cherry-picked prompts.
