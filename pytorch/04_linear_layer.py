...
# difference between convoluitonal layer and linear layer is that in CNN layers, you treat input as three dimensions and use receptive fields to understand the data and learn it, whereas 