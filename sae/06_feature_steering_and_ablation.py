...
# - Compare local effects (single prompt) vs global effects (evaluation set).
# - Use intervention results to validate whether interpreted features are causally meaningful.
